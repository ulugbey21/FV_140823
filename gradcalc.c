        ...
        if(brch->cl->fc[f].bc==0) {
          ...
          brch->el->SG[iv][0]+=0.5*(run->sol1->vec[iv]+run->sol->vec[iv])*brch->cl->nx[f]*brch->cl->Area[f][ing]/brch->cl->Vol;
	        ...
	        brch->el->SG[iv][2]+=0.5*(run->sol1->vec[iv]+run->sol->vec[iv])*brch->cl->nz[f]*brch->cl->Area[f][ing]/brch->cl->Vol;
              ...
              brch->el->SG[run->con->neq][0]+=0.5*(run->sol1->p_hydro+run->sol->p_hydro)*brch->cl->nx[f]*brch->cl->Area[f][ing]/brch->cl->Vol;
	      brch->el->SG[run->con->neq][1]+=0.5*(run->sol1->p_hydro+run->sol->p_hydro)*brch->cl->ny[f]*brch->cl->Area[f][ing]/brch->cl->Vol;
	      brch->el->SG[run->con->neq][2]+=0.5*(run->sol1->p_hydro+run->sol->p_hydro)*brch->cl->nz[f]*brch->cl->Area[f][ing]/brch->cl->Vol;
